...
class Product {
    constructor(id, name, shortDescription, price, images, categoryID, description, variationTypes, rating, inStock, expeditionTime, discount, taxID, productCode, stockCode, weight, size) {
        this.id = id;
        this.name = name;
